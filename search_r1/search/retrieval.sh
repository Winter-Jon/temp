...
DATASET_PATH="/data/home/zhangjing1/repos/fengxiang/rag_reasoning/Search-R1/data/$DATA_NAME"

SPLIT='test'
TOPK=3

INDEX_PATH=/data/home/zhangjing1/repos/fengxiang/rag_reasoning/Search-R1/data
CORPUS_PATH=/data/home/zhangjing1/repos/fengxiang/rag_reasoning/Search-R1/data/wiki-18.jsonl
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python retrieval.py --retrieval_method e5 \
                    ...
                    --retrieval_pooling_method "mean" \hao
